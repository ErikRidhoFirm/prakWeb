...
if (isset($_POST["submit"])) {
    ...
    if (in_array($documentFileType, $allowedExtensions) && $_FILES["documentToUpload"]["name"] <= $maxFileSize) {
        ...
        echo "Jenis dokumen tidak vaid atau melebihi ukuran maksimum yang diizinkan";
    }
}