...
<html>
    ...
    <body>
            ...
            if (mysqli_num_rows($result) > 0){
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    echo "<tr>
                            ...
                            <a href='#' onclick='konfimasiHapus(" . $row["id"] . ", \"" . $row["nama"] . "\")'>Hapus</a></td>
                            </tr>";
                }
                echo "</table";
            }else{
        ...
        <script>
            function konfimasiHapus(id, nama){
                var konfirmasi = confirm("Apakah anda yakin ingin menghapus data dengana nama" . nama + "?");
                if (konfirmasi){
